...
-- =====================================================
-- 7. Teacher Assignments Table (Multi-Department Support)
-- =====================================================
...
('firebase_service_account_json', '', 'string', 'Firebase Cloud Messaging service account JSON', FALSE),
('firebase_project_id', '', 'string', 'Firebase Cloud Messaging project ID', FALSE),
