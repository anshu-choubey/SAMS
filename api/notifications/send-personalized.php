...
try {
    ...
    $firebaseHelperPath = dirname(__DIR__, 2) . '/config/firebase-impl.php';
    require_once $firebaseHelperPath;
    ...
    // Send via FCM
    $tokenQuery = "SELECT {$tokenColumn} AS token FROM fcm_tokens WHERE user_id = :user_id AND is_active = TRUE LIMIT 1";
